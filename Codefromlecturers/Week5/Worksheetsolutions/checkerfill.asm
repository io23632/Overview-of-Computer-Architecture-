...
M=D
	...
	(colloop)
		...
		// If c isn't pressed, update cpressed <- 0
		@KBD
		D=M
		@67
		D=D-A
		...
		// Otherwise, if c is pressed and cpressed == 1 (so the press has been handled), do nothing)		
		(handlecpress)
		@cpressed
		D=M
		@endchandle
		...
		// Otherwise, toggle cactive and set cpressed <- 1.
		@cpressed
		M=1
		@cactive
		D=M
